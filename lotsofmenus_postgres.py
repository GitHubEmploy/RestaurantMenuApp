...
from pg_database_setup import Restaurant, Base, MenuItem, User
...
user1 = User(name = "Gaurav", email='gauravsinghaec@gmail.com');
...
menuItem3 = MenuItem(name = "Gyoza", description = "The most prominent differences between Japanese-style gyoza and Chinese-style jiaozi are the rich garlic flavor, and the fact that gyoza wrappers are much thinner", price = "", course = "", restaurant = restaurant1, user_id=1)
